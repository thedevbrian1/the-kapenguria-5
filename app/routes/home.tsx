...
export default function Home() {
  return (
    <div className="font-sans leading-relaxed text-gray-800 bg-white">
      <Header />
      <main>
        <HeroSection />
        <FeaturesSection />
...
const Header = () => (
  <header className="bg-white py-4 border-b border-gray-200 sticky top-0 z-50">
    <div className="max-w-6xl mx-auto px-5 flex justify-between items-center">
      ...
      <nav>
        <a href="#features" className="ml-5 text-gray-600 font-medium hover:text-green-600">About</a>
        <a href="#contact" className="ml-5 text-gray-600 font-medium hover:text-green-600">Contact Us</a>
        <a href="/signup" className="ml-5 bg-blue-600 text-white py-2 px-4 rounded-lg font-medium hover:bg-green-700 transition-colors">Log In</a>
      </nav>
    </div>
  </header>
);
  ...
  >
    ...
    <div className="max-w-6xl mx-auto px-5 flex flex-col items-center">
      ...
      <p className="relative text-lg text-gray-200 max-w-2xl mx-auto mb-8">
        Join our community-driven forest protection platform. Report threats, learn conservation, and earn rewards for your efforts.
      </p>
      <button className="relative bg-green-600 text-white border-none py-4 px-8 text-base font-semibold rounded-lg cursor-pointer transition-colors hover:bg-green-700">
        Get Started
      </button>
    </div>
  </section>
...
const Footer = () => (
  <footer id="contact" className="bg-green-800 text-white py-5 text-center">
    <div className="max-w-6xl mx-auto px-5">
      <p>&copy; {new Date().getFullYear()} Mazingira 360. All Rights Reserved.</p>
    </div>
  </footer>
);
